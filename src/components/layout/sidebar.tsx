...
const menuItems = [
    ...
    { href: "/dashboard/fases", label: "Fases", icon: Layers, adminOnly: true },
...
export function Sidebar({ className }: SidebarProps) {
    ...
    return (
        <aside className={cn("fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-gray-200", className)}>
            <div className="flex h-full flex-col">
                ...
                <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
                    ...
                    <div>
                        <span className="text-lg font-bold text-gray-900">GEM</span>
                        <p className="text-xs text-gray-500">Gestão de Ensino Musical</p>
                    </div>
                </div>
