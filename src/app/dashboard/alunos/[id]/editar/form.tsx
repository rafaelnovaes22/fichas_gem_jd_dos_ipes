...
export function EditarAlunoForm({ aluno, instrumentos, fases, instrutores }: EditarAlunoFormProps) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : "Erro ao desativar aluno");
        } finally {
            setDeleting(false);
        }
    };
